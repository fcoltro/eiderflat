use eiderflat_io::{export_dxf, import_dxf, export_svg, import_svg, to_e2d, from_e2d};
use eiderflat_document::{Document, EntityKind};
use eiderflat_geometry::{Curve, LineSeg, CircularArc, Point2d};
...
fn native_multi_entity_fidelity() {
    let mut doc = Document::new();
    doc.layers.add(eiderflat_document::Layer::new("detail").with_color(0, 255, 0));
